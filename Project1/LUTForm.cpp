...
System::Void LuccME::LUTForm::tLUT_Enter(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void LuccME::LUTForm::LUTForm_Shown(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void LuccME::LUTForm::LUTForm_FormClosing(System::Object ^ sender, System::Windows::Forms::FormClosingEventArgs ^ e)
{
	if (!close) {
		this->lReturn->Return = "";
		...
		if (aux != this->lReturn->Return) {
			if (MessageBox::Show(gSLUTMod, gSExit, MessageBoxButtons::YesNo, MessageBoxIcon::Question) == LuccME::DialogResult::No) {
				e->Cancel = true;
			}
			else {
...
System::Void LuccME::LUTForm::lvLUT_SelectedIndexChanged(System::Object ^ sender, System::EventArgs ^ e)
{	
	bUpLUT->Visible = false;
	bDownLUT->Visible = false;
	bRemLUT->Visible = false;
...
System::Void LuccME::LUTForm::bRemLUT_Click(System::Object ^ sender, System::EventArgs ^ e)
{
	for (int i = 0; i < lvLUT->Items->Count; i++) {
		if (lvLUT->Items[i]->Selected) {
...
System::Void LuccME::LUTForm::bUpLUT_Click(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void LuccME::LUTForm::bDownLUT_Click(System::Object ^ sender, System::EventArgs ^ e)
{
	String^ aux = gcnew String("");
	for (int i = 0; i < lvLUT->Items->Count; i++) {
		if (lvLUT->Items[i]->Selected) {
...
System::Void LuccME::LUTForm::LUTForm_Click(System::Object ^ sender, System::EventArgs ^ e)
{
	for (int i = 0; i < lvLUT->Items->Count; i++) {
...
System::Void LuccME::LUTForm::bSalvar_Click(System::Object ^ sender, System::EventArgs ^ e)
{
	this->lReturn->Return = "";
	for (int i = 0; i < lvLUT->Items->Count; i++) {
		this->lReturn->Return += "\"";
