...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// bUpLUT
			// 
			this->bUpLUT->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"bUpLUT.Image")));
			...
			// bDownLUT
			// 
			this->bDownLUT->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"bDownLUT.Image")));
