...
System::Void LuccME::P_ContinuousR::copyToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	switch (tcRegions->SelectedIndex)
	{
	case 0:
...
System::Void LuccME::P_ContinuousR::pasteToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	switch (tcRegions->SelectedIndex)
	{
	case 0:
