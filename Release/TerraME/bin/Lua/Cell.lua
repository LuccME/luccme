...
Cell_ = {
	...
	getAgent = function(self, placement)
		...
		if type(self[placement]) == "Group" then
			...
			customErrorMsg("Error: Placement '".. placement.. "' should be a Group, got "..type(self[placement])..".", 3)
		end
	end,
	...
	isEmpty = function(self, placement)
		...
		if type(self[placement]) == "Group" then
			return self[placement].agents:size() 
		else
			customErrorMsg("Error: Placement '".. placement.. "' should be a Group, got "..type(self[placement])..".", 3)
		end
	end,
	...
	-- @param id A string with the neighborhood's name to be retrieved.
	-- Default is "neigh1".
	-- @usage cell_neighbor = cell:sample("moore")
	-- @see getNeighborhood
	sample = function(self, id, randomObj)
		return self:getNeighborhood(id):sample(randomObj)
	end,
